...
if __name__ == "__main__":
    ...
    data = read_csv(path, ",", True, True)
    print(f'Testing the read_csv\n')
    print(data.X.shape, data.y.shape)
    print(data.summary())
    #Testing the write_csv
    path1 = "/Users/danielalemos/si/datasets/dataset.csv"
    write_csv(path1,data, ",", True, True)