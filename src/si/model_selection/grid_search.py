...
def grid_search_cv(model, dataset: Dataset, parameter_grid: Dict[str, Tuple], scoring: Callable = None, cv: int = 5, test_size: float = 0.2) -> List[Dict[str, Any]]:
    """
    Performs a grid search cross validation on a model.
    Returns the scores of the model on the dataset.
